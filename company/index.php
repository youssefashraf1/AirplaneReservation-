...
<body>
    ...
    <div class="main">
      ...
      <div class="intro">
        ...
        <p>here you can add flight as you want and it will apper to passengers </br> and let them reserve it if they can</p>
        <div class="buttons">
        <button class="btn1"><a href="addFlight.php" class="tt1">Add Flight</a></button>
        <button class="btn2"><a href="flights.php" class="tt1" >Flights</a></button>
        </div>
    </div>
